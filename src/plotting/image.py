...
def plotImage(record, history=10, vmin=None, vmax=None, log=False, 
        mask=None, msg=None, alert=False, name=None, group=None, 
        send_rate=None, roi_center=None, roi_diameters=None):
    """Plotting an image.
    ...
    # Rotations and flips for pnCCD at FLASH. Needs to be moved elsewhere.
    image_to_show = np.fliplr(np.flipud(image.T*mask.T)) 
    ipc.new_data(n, image_to_show, msg=msg, alert=alert, send_rate=send_rate, center=roi_center, diameters=roi_diameters)
