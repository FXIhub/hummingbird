...
state['FLASH/DataGlob'] = '/gpfs/cfel/cxi/data/2016/FLASH-2016-Chapman-May/raw/pnccd/data/PS1_20160528_0608*.frms6'
#state['FLASH/CalibGlob'] = '/gpfs/cfel/cxi/data/2016/FLASH-2016-Chapman-May/raw/pnccd/calib/'
state['FLASH/CalibGlob'] = '/gpfs/cfel/cxi/data/2016/FLASH-2016-Chapman-May/raw/pnccd/calib/'
#state['FLASH/DAQFolder'] = '/gpfs/cfel/cxi/data/2016/FLASH-2016-Chapman-May/raw/daq/chapman2016-05/'
state['FLASH/DAQFolder'] = '/home/tekeberg/Beamtimes/Holography2017/fake_daq_data'
...
def onEvent(evt):
    ...
    plotting.correlation.plotScatter(evt["motorPositions"]["InjectorX"], evt["motorPositions"]["InjectorZ"],
                                     name="Injector X vs Z", xlabel="InjectorX", ylabel="InjectorZ",
                                     group="Injector")
