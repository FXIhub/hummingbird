# -*- coding: utf-8 -*-
#
# SPI Online Analysis documentation build configuration file, created by
...
try:
    ...
    MOCK_MODULES = ['PyQt4','psana','sip','numpy','scipy','scipy.sparse', 'zmq','zmq.eventloop','zmq.eventloop.zmqstream','pyqtgraph', 'pytz', 'h5py']
...
# the title page.
latex_logo = 'images/latex_logo.pdf'
...
texinfo_documents = [
  ('index', 'Hummingbird', u'Hummingbird Documentation',
   u'FXIhub', 'SPIOnlineAnalysis', 'One line description of project.',
   'Miscellaneous'),
]
