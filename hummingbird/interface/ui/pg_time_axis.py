...
class DateAxisItem(AxisItem):
    ...
    def attachToPlotItem(self, plotItem):
        ...
        self.setZValue(-1000)
        self.setVisible(self._oldAxis.isVisible())
        # self.show()
        self._oldAxis.hide()
    ...
    def detachFromPlotItem(self):
        ...
        (not yet implemented)
        """
        plotItem = self.parentItem()
        viewBox = plotItem.getViewBox()
        self._oldAxis.setParentItem(plotItem)
        self._oldAxis.linkToView(viewBox)
        plotItem.axes[self.orientation]['item'] = self._oldAxis
        pos = plotItem.axes[self.orientation]['pos']
        plotItem.layout.removeItem(plotItem.layout.itemAt(*pos))
        self.hide()
        plotItem.layout.addItem(self._oldAxis, *pos)
